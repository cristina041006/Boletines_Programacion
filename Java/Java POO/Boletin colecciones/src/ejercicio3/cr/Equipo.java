...
public class Equipo<T> {
	...
	public Equipo(String nombre) {
		super();
		this.nombre=nombre;
		jugadores= new ArrayList<T>();
	}
	
	public boolean addAlumno(T alum) throws Exception {
	...
	public boolean borrarAlumno (T alum) throws Exception {
	...
	public Boolean pertenece (T alum) {
